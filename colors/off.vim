...
let s:dark_red        = s:light_black
let s:light_red       = s:light_black
...
let s:dark_green      = s:light_black
let s:light_green     = s:light_black
let s:dark_purple     = s:light_black
let s:light_purple    = s:light_black
let s:yellow          = s:light_black
let s:dark_yellow     = s:light_black
...
call s:h("Todo",          {"fg": s:light_black, "gui": "bold", "cterm": "bold"})
call s:h("SpecialKey",    {"fg": s:light_green})
call s:h("NonText",       {"fg": s:medium_gray})
call s:h("Directory",     {"fg": s:dark_blue})
call s:h("ErrorMsg",      {"fg": s:pink})
call s:h("IncSearch",     {"bg": s:pink, "fg": s:light_black})
call s:h("Search",        {"bg": s:pink, "fg": s:light_black})
call s:h("MoreMsg",       {"fg": s:medium_gray, "cterm": "bold", "gui": "bold"})
hi! link ModeMsg MoreMsg
call s:h("LineNr",        {"fg": s:bg_subtle})
call s:h("CursorLineNr",  {"fg": s:blue, "bg": s:bg_very_subtle})
call s:h("Question",      {"fg": s:red})
call s:h("StatusLine",    {"bg": s:bg_very_subtle, "fg": s:white})
call s:h("StatusLineNC",  {"bg": s:bg_very_subtle, "fg": s:actual_white})
